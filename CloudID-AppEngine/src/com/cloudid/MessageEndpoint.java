 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "cloudid.com", ownerName = "cloudid.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDrFkI68rUUQWVK6aiWhvNpbGGk_XFKCu4";
