 ...
 * on 2014-04-28 at 17:35:34 UTC 
 * Modify at your own risk.
 */

package com.cloudid.noteendpoint;
...
public class Noteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetNote extends NoteendpointRequest<com.cloudid.noteendpoint.model.Note> {
    ...
    protected GetNote(java.lang.String id) {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.cloudid.noteendpoint.model.Note.class);
   ...
   *
   * @param content the {@link com.cloudid.noteendpoint.model.Note}
   * @return the request
   */
  public InsertNote insertNote(com.cloudid.noteendpoint.model.Note content) throws java.io.IOException {
    InsertNote result = new InsertNote(content);
    initialize(result);
    return result;
  }

  public class InsertNote extends NoteendpointRequest<com.cloudid.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected InsertNote(com.cloudid.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "POST", REST_PATH, content, com.cloudid.noteendpoint.model.Note.class);
    }
  ...
  public class ListNote extends NoteendpointRequest<com.cloudid.noteendpoint.model.CollectionResponseNote> {
     ...
     */
    protected ListNote() {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.cloudid.noteendpoint.model.CollectionResponseNote.class);
    }
   ...
   * @return the request
   */
  public UpdateNote updateNote(com.cloudid.noteendpoint.model.Note content) throws java.io.IOException {
    UpdateNote result = new UpdateNote(content);
    initialize(result);
    return result;
  }

  public class UpdateNote extends NoteendpointRequest<com.cloudid.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected UpdateNote(com.cloudid.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "PUT", REST_PATH, content, com.cloudid.noteendpoint.model.Note.class);
    }
