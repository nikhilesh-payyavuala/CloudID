...
public class ConfirmUserDetailsDialogFragment extends DialogFragment {
	
	//UserID id;
	private TextView fn,ln,ufid,dob;
	
	public static ConfirmUserDetailsDialogFragment newInstance(String[] id) {
		ConfirmUserDetailsDialogFragment frag = new ConfirmUserDetailsDialogFragment();
